...
class SandBottleNeck(nn.Module):
    def __init__(self,
        ...
        custom_conv = build_op(conv_type)
        ...
        conv_dict["dw2"] = custom_conv(expansion_channels, expansion_channels, stride=1, kernel_size=kernel_size,
                                       groups=expansion_channels, act_cfg=act_cfg, norm_cfg=norm_cfg)
        ...
        if in_channels == mid_channels * expansion and stride == 1:
            ...
            shortcut_dict["dw"] = custom_conv(in_channels, in_channels, stride=stride, kernel_size=kernel_size,
                                              groups=in_channels, act_cfg=act_cfg, norm_cfg=norm_cfg)

...
#
#         conv_dict["dw1"] = CONV_TYPE(in_channels, in_channels, stride=stride, kernel_size=kernel_size, groups=in_channels)
...
#         conv_dict["dw2"] = CONV_TYPE(expansion_channels, expansion_channels, stride=1, kernel_size=kernel_size, groups=expansion_channels)
#
...
#             shortcut_dict["dw"] = CONV_TYPE(in_channels, in_channels, stride=stride, kernel_size=kernel_size, groups=in_channels)
#
#             shortcut_dict["pw"] = ConvModule(in_channels, expansion_channels, kernel_size=1, stride=1, act_cfg=act_cfg, norm_cfg=norm_cfg)

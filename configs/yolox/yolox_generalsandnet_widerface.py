...
data_root = '/media/traindata_ro/users/yl3076/ImageDataSets/WIDERFACE/'
...
log_level = 'INFO'
work_dir = './work_dirs/face_det/yolox_general_load_from_2'
load_from = './work_dirs/face_det/yolox_general_load_from/latest.pth'
resume_from = None
workflow = [('train', 1)]

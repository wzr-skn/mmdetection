...
train_pipeline = [
    ...
    dict(type='CenterBoxCrop', max_num=5, crop_factor=[4, 4, 4, 4]),
...
log_level = 'INFO'
work_dir = './work_dirs/head_detect/custom_yolox_generalsandnet_yolox_pafpn_repvgg_centercrop_320_180_6datasets'
load_from = './work_dirs/head_detect/custom_yolox_generalsandnet_yolox_pafpn_centercrop_320_180_6datasets_load_from/latest.pth'
resume_from = None
workflow = [('train', 1)]

...
log_level = 'INFO'
work_dir = './work_dirs/head_detect/custom_yolox_generalsandnet_1output_noobj_2value_6datasets_customdata_filter_no_keep_0.05bboxcutout_640_480_load_from'
load_from = '../work_dirs/head_detect/custom_yolox_generalsandnet_1output_noobj_2value_6datasets_customdata_filter_no_keep_0.05bboxcutout_640_480/latest.pth'
resume_from = None
workflow = [('train', 1)]

...
train_pipeline = [
    ...
    dict(type='CenterBoxCrop', max_num=3, crop_factor=[2, 2, 2, 2]),
...
slight_bboxcutout_train_pipeline = [
    ...
    dict(type='CenterBoxCrop', max_num=3, crop_factor=[2, 2, 2, 2]),
    dict(type='Pad', pad_to_square=True),
    dict(type='Bbox_CutOut', cutout_ratio=[0, 0.1], prob=0.05, fill_in=(0, 0, 0)),
    # dict(
    #     type='CutOut',
    #     n_holes=(0, 2),
    #     cutout_ratio=[(0.05, 0.1), (0.1, 0.05), (0.1, 0.1)]),
...
log_level = 'INFO'
work_dir = './work_dirs/head_detect/custom_yolox_generalsandnet_yolox_pafpn_centercrop_640_640_6datasets_load_from'
load_from = './work_dirs/head_detect/custom_yolox_generalsandnet_yolox_pafpn_centercrop_640_640_6datasets/latest.pth'
resume_from = None
workflow = [('train', 1)]
...
model = dict(
    type='YOLOX',
    backbone=dict(type='CSPDarknet_no', deepen_factor=0.33, widen_factor=0.25, out_indices=(1, 2, 3, 4),
            arch_ovewrite=[[96, 128, 3, True, False], [128, 256, 9, True, False],
            [256, 512, 9, True, False], [512, 1024, 3, False, True]],
            conv_cfg=dict(type='RepVGGConv'), conv_type='RepVGGBlock'),
    neck=dict(
        type='YOLOXPAFPN_DBB',
...
train_pipeline = [
    ...
    dict(type='CenterBoxCrop', max_num=3, crop_factor=[8, 8, 8, 8]),
...
log_level = 'INFO'
work_dir = './work_dirs/optimize_head_detect/final_320x320_bigger_1output_yolox_cspdarknet_no_pafpn_RepVGG_3datasets_filter_big_centerboxcrop_big_scale_no_keep_2_10'
load_from = './work_dirs/optimize_head_detect/final_320x320_bigger_1output_yolox_cspdarknet_no_pafpn_RepVGG_3datasets_filter_medium_centerboxcrop_big_scale_no_keep/latest.pth'
resume_from = None
workflow = [('train', 1)]

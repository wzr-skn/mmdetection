...
class VFNetMultiAnchor(ATSSHead, FCOSHead):
    ...
    def __init__(self,
        ...
        # 将所有的anchor_generator替换成prior_generator，否则会报 AttributeError: can't set attribute，原因还没搞懂。？？？
        # self.anchor_generator = build_anchor_generator(anchor_generator)
        self.num_base_priors = self.prior_generator.num_base_priors[0]
        # 同理，将所有的num_anchors替换成num_base_priors，否则也会报 AttributeError: can't set attribute
